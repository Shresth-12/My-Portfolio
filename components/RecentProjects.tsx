    ...
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center  p-4 gap-x-24 gap-y-8 mt-10'>
            {projects.map(({id,title,des,img,iconLists,link})=>(
                <div key={id} className='sm:h-[41rem] lg:min-h-[32.rem] h-[32rem] flex justify-center sm:w-[570px] w-[80vh]'>
                   ...
                   <div className='relative flex items-center justify-center sm:w-[570px] w-[80vh] overflow-hidden sm:h-[40vh] h-[30vh] mb-10'>
                    ...
                    <div className='flex items-center justify-between mt-7 mb-3'>
                        ...
                        <div className='flex justify-center items-center'>
                            <p className='flex lg:tex-xl md:text-xs text-sm text-purple'>Check Live Site</p>
